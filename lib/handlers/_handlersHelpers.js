/*
 * Helper sub-methods for handlers.
 * 
 */
...
// Validate protocol
_handlersHelpers.validateProtocol = protocol => {
...
// Validate URL
_handlersHelpers.validateURL = url => {
...
// Validate method
_handlersHelpers.validateMethod = method => {
...
_handlersHelpers.validateSuccessCodes = successCodes => {
...
_handlersHelpers.validateTimeoutSeconds = timeoutSeconds => {
...
// Validate userChecks 
_handlersHelpers.validateUserChecks = userChecks => {
...
// Validate a token id
_handlersHelpers.validateTokenID = tokenID => {
...
// Validate a token
_handlersHelpers.getToken = token => {
...
// Validate extend
_handlersHelpers.validateExtend = extend => {
...
_handlersHelpers.validateToken = (tokenID, userPhoneNumber, cb) => {
...
// Validate firstName
_handlersHelpers.validateFirstName = firstName => {
...
// Validate lastName
_handlersHelpers.validateLastName = lastName => {
...
_handlersHelpers.validatePhoneNumber = phoneNumber => {
...
// Validate password
_handlersHelpers.validatePassword = password => {
...
_handlersHelpers.validateTOSAgreement = tosAgreement => {
...
_handlersHelpers.validateMessage = msg => {
...
// Export module
module.exports = _handlersHelpers;