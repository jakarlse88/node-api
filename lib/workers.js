            ...
            checks.forEach(check => {
                ...
                _data.read('checks', check, (err, originalCheckData) => {
                    if (!err && originalCheckData) {
                        ...
                        console.log('Error: could not read check data:', err);
                    }
                });
            });
        } else {
...
workers.validateCheckData = originalCheckData => {
    ...
    if (originalCheckData.id &&
        ...
        console.log('Error: one of the checks is improperly formatted and was skipped');
    }
};
...
workers.log = (originalCheckData, checkOutcome,
    ...
    _logs.append(logFileName, logString, err => {
        if (!err) {
            console.log('Logfile successfully written');
        } else {
            console.log('Error writing log data to file');
        }
    });
};
